...
public class EmpleadosAdapter extends ArrayAdapter<Empleado> {
    ...
    public static ArrayList<Empleado> empledejefe = new ArrayList<>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (aux == null) {
            ...
            holder.add=(Button) aux.findViewById(R.id.btn_addtojefe);
        ...
        holder.add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                empledejefe.add(Bd.getEmpleados().get(position));
            }
        });
